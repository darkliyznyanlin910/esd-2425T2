...
exports.getStatusQuery =
  exports.deliveredSignal =
  exports.pickedUpSignal =
    void 0;
exports.order = order;
...
var _a = (0, workflow_1.proxyActivities)({
  ...
  chargeCustomer = _a.chargeCustomer,
  refundOrder = _a.refundOrder,
  sendPushNotification = _a.sendPushNotification;
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          err_1 = _a.sent();
          message = "Failed to charge customer for "
            .concat(product.name, ". Error: ")
            .concat((0, temporal_common_1.errorMessage)(err_1));
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            (0, workflow_1.condition)(function () {
              return state === "Picked up";
            }, "1 min"),
          ];
        case 6:
        ...
        case 7:
          _a.sent();
          throw workflow_1.ApplicationFailure.create({
            message: "Not picked up in time",
          });
        case 8:
          return [4 /*yield*/, sendPushNotification("🚗 Order picked up")];
        case 9:
          _a.sent();
          return [
            4 /*yield*/,
        ...
        case 12:
          return [4 /*yield*/, sendPushNotification("✅ Order delivered!")];
        case 13:
          _a.sent();
        ...
        case 14:
          ...
          return [
            ...
            sendPushNotification(
              "\u270D\uFE0F Rate your meal. How was the ".concat(
...
function refundAndNotify(product, message) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, refundOrder(product)];
        case 1:
          _a.sent();
          return [4 /*yield*/, sendPushNotification(message)];
        case 2:
