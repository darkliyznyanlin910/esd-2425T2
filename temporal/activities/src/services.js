...
exports.notificationService = {
    sendNotification: function (_a) {
        ...
        if (Math.random() < 0.7) {
            throw new Error("Failed to send ".concat(type, " notification. Unable to reach notification service."));
        }
...
exports.paymentService = {
    charge: function (cents) {
        ...
        var _idempotencyToken = "".concat((0, activity_1.activityInfo)().workflowExecution.workflowId, "-charge");
        if (cents >= 3500) {
    ...
    refund: function (cents) {
        // In a real app, we would pass an idempotency token to the downstream service
        var _idempotencyToken = "".concat((0, activity_1.activityInfo)().workflowExecution.workflowId, "-refund");
        if (Math.random() < 0.7) {
